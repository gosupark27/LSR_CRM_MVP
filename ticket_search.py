...
def add_ticket(customer_id, pickup_date, note =''):
    with db.engine.begin() as connection:
...
def add_item(ticket_id, item_type, category, note=''):
    with db.engine.begin() as connection:
...
def add_repair(item_id, rp_service, note=''):
    with db.engine.begin() as connection:
...
def add_payment(ticket_id, total, deposit):
    with db.engine.begin() as connection:
...
def intake(first_name, last_name, phone, email, pickup_date, item_type, category, rp_service, total, deposit):
    customer_id = add_customer(first_name, last_name, phone, email)
    ticket_id, dropoff_date, tk_status = add_ticket(customer_id, pickup_date)
    item_id, item_note = add_item(ticket_id, item_type, category)
    repair_note = add_repair(item_id, rp_service)
    balance = add_payment(ticket_id, total, deposit)
